    ...
    private var controlsOverlay: some View {
        VStack {
            ...
            HStack {
                ...
                // Debug subtitle button
                Button {
                    coordinator.debugSubtitleState()
                } label: {
