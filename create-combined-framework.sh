...
# Step 6: Copy to dist/release for Package.swift
echo ""
echo "Step 6: Copying to dist/release..."
rm -rf "$RELEASE_DIR/MPVKit.xcframework"
cp -R "$XCF_PATH" "$RELEASE_DIR/MPVKit.xcframework"
echo "  ✓ Copied to dist/release/MPVKit.xcframework"
...
echo "  For SPM:     $RELEASE_DIR/MPVKit.xcframework"
echo "  Zip: $ZIP_PATH"
echo ""
ls -lh "$ZIP_PATH"
